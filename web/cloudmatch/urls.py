...
urlpatterns = [
    ...
    url(r'^lake_to_site_download/(?P<id>.+)/', views.lake_to_site_download, name ='lake_to_site_download'),
    ...
    url(r'^sites/(?P<page>\d+)/', views.sites, name ='sites'),
    ...
    url(r'^characteristics_graph/(?P<charac>.+)/', views.characteristics_graph, name ='characteristics_graph'),
