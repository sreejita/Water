...
class Boundingbox(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'wisconsin\".\"boundingbox'
...
class Waterbodies(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'wisconsin\".\"waterbodies'
